<div class="container section-marginTop text-center">
    ...
    <div class="row">
        ...
        <div id="one"  class="owl-carousel mb-4 owl-theme">
            @foreach($projectData as $peoject)
            <div class="item m-1 card">
                <div class="text-center">
                    <img class="w-100" src="{{$peoject->project_img}}" alt="Card image cap">
                    <h5 class="service-card-title mt-4">{{$peoject->project_name}}</h5>
                    <h6 class="service-card-subTitle p-0 m-0">{{$peoject->project_desc}} </h6>
                    <a href="{{$peoject->project_link}}" target="_blank" class="normal-btn-outline mt-2 mb-4 btn">বিস্তারিত</a>
                </div>
            </div>
            @endforeach
